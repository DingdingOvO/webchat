  ...
  if (messages.length === 0) {
    return (
      <div className="empty-state" style={{
        ...
        justifyContent: 'center', color: 'var(--text-faint)', fontSize: 'var(--fs-sm)', gap: 'var(--p3)',
      }}>
      ...
      {messages.map((m, idx) => {
        ...
        return (
          <div
            ...
            style={{
              display: 'flex', flexDirection: 'column', marginBottom: 'var(--p4)',
              maxWidth: '68%',
          ...
          >
            {showSender && (
              <span style={{ fontSize: 'var(--fs-xs)', color: 'var(--primary)', fontWeight: 500, marginBottom: 2, padding: '0 var(--p2)' }}>
                {m.senderName}
              </span>
            )}
            <div style={{
